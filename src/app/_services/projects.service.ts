...
export class ProjectsService {
  ...
  projects: Project[] = [
    ...
    {id: 3, name: "Bulky Web App", pictures: ["../../assets/Image1.png","../../assets/Image2.png","../../assets/Image3.png"], projectLink: "//www.github.com", summary: "Real world e-commerce web app developed using ASP.NET(.NET 8) and Bootstrap.", description: "This is a real-world based e-commerce web application, done with Bootstrap v5, ASP.NET MVC and ASP.NET Core(.NET 8). Having features like google/facebook authentication, stripe payment integrations, and email notifications.", tags: [Tag.CSHARP, Tag.ASPNET]},
